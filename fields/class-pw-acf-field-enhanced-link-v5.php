...
if( !class_exists('pw_acf_field_enhanced_link') ) :


class pw_acf_field_enhanced_link extends acf_field_link {
  ...
  function initialize() {
		...
		$this->label = __("Enhanced Link",'pwacfen');
  ...
  function get_link( $value = '' ) {
	...
	function __construct( $settings ) {
		...
		*/
		...
		$this->label = __('Enhanced Link', 'pwacf');
		...
		*/
		...
		$this->l10n = array(
			// 'error'	=> __('Error! Please enter a higher value', 'pwacf'),
		);
  ...
  //
	...
	// 	// 	'label'			=> __('Font Size','pwacf'),
	// 	// 	'instructions'	=> __('Customise the input font size','pwacf'),
	// 	// 	'type'			=> 'number',
	// 	// 	'name'			=> 'font_size',
	// 	// 	'prepend'		=> 'px',
	// 	// ));
...
<?php
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		// register & include JS
		wp_register_script('pw_acf_enhanced_link-js', "{$url}assets/js/input.js", array('acf-input'), $version);
		wp_enqueue_script('pw_acf_enhanced_link-js');


		// register & include CSS
		wp_register_style('pw_acf_enhanced_link-css', "{$url}assets/css/input.css", array('acf-input'), $version);
		wp_enqueue_style('pw_acf_enhanced_link-css');
  ...
  //
	...
	// 	if( $value < $field['custom_minimum_setting'] )
	// 	{
	// 		$valid = __('The value is too little!','pwacf'),
	// 	}
  //
  //
	// 	// return
...
// initialize
new pw_acf_field_enhanced_link( $this->settings );
