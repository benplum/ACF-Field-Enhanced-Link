...
class ACF_Plugin_Enhanced_Link_Field_Updater {
  ...
  public static function get_instance() {
    if ( empty( self::$instance ) && ! ( self::$instance instanceof ACF_Plugin_Enhanced_Link_Field_Updater ) ) {
      self::$instance = new ACF_Plugin_Enhanced_Link_Field_Updater();
    }
  ...
  public function __construct() {
    $this->parent = ACF_Plugin_Enahnced_Link_Field::get_instance();
